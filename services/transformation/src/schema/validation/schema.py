...
class SchemaValidator:
    ...
    def _validate_dependencies(self):
        ...
        try:
            ...
            if cycles:
                self.errors.append(f"Circular dependencies detected: {cycles}")
    ...
    def _validate_table(self, table_name: str, table_def: Dict):
        ...
        if "indices" in table_def:
            self._validate_indices(
                table_name, table_def["indices"], table_def["columns"]
            )
    ...
    def _validate_indices(
        self, table_name: str, indices: List[Index], columns: Dict[str, Column]
    ):
            ...
            for subsection in section.values():
                for table_name in subsection.keys():
                    ...
                    if not table_name.isidentifier():
                        self.errors.append(f"Invalid table name '{table_name}'")
